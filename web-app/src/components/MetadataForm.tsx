  ...
  return (
    <div className="bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_8px_32px_rgba(0,0,0,0.5)] p-6 rounded-3xl flex flex-col gap-5 mt-2">
      ...
      <div className="flex flex-col gap-2">
        <label className="text-xs font-bold text-[#b3b3b3] uppercase tracking-wider">Title</label>
        <input 
          type="text" 
          value={title} 
          onChange={e => setTitle(e.target.value)} 
          className="bg-black/20 backdrop-blur-sm border border-white/10 shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] text-white px-4 py-3 rounded-xl text-sm font-medium focus:outline-none focus:border-[#1ed760]/50 focus:ring-1 focus:ring-[#1ed760]/50 transition-all placeholder-[#b3b3b3]/50"
          placeholder="Track name"
        />
      </div>
      
      <div className="flex flex-col gap-2">
        <label className="text-xs font-bold text-[#b3b3b3] uppercase tracking-wider">Artist</label>
        <input 
          type="text" 
          value={artist} 
      ...
      <div className="flex flex-col gap-2">
        <label className="text-xs font-bold text-[#b3b3b3] uppercase tracking-wider">Album</label>
        <input 
          type="text" 
          value={album} 
