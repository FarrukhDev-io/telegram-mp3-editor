...
var i = {
	...
	createBuffer: function(t, e) {
		...
		if ("number" == typeof t[0] && (t = [t]), !t[0] || 0 === t[0].length) throw new Error("channelData must contain non-empty channel arrays");
		(function(t) {
			const e = t[0];
			if (e.some(((t) => t > 1 || t < -1))) {
				const i = e.length;
...
var a = { fetchBlob: function(e, i, n) {
	return t(this, void 0, void 0, (function* () {
		var s;
			...
			t(this, void 0, void 0, (function* () {
				...
				try {
					for (;;) {
						...
						if (e.done) break;
						if (o += (null === (t = e.value) || void 0 === t ? void 0 : t.length) || 0, r > 0) i(Math.round(o / r * 100));
					}
				} catch (t) {
...
var C = class extends e {
	constructor(t, e) {
		super(), this.timeouts = [], this.isScrollable = !1, this.audioData = null, this.resizeObserver = null, this.lastContainerWidth = 0, this.isDragging = !1, this.subscriptions = [], this.unsubscribeOnScroll = [], this.dragStream = null, this.scrollStream = null, this.containerInlinePadding = 0, this.onClickWrapper = (t) => {
			const [i, n] = m(this.wrapper.getBoundingClientRect(), t.clientX, t.clientY);
			this.emit("click", i, n);
	...
	initDrag() {
		...
		this.dragStream = function(t, e = {}) {
			const { threshold: i = 3, mouseButton: n = 0, touchDelay: s = 100 } = e, r = l(null), o = /* @__PURE__ */ new Map(), a = matchMedia("(pointer: coarse)").matches;
			let h = () => {};
			const c = (e) => {
				...
				const p = Date.now(), { left: g, top: f } = t.getBoundingClientRect(), v = (t) => {
				...
				document.addEventListener("pointermove", v), document.addEventListener("pointerup", b), document.addEventListener("pointerout", y), document.addEventListener("pointercancel", y), document.addEventListener("touchmove", S, { passive: !1 }), document.addEventListener("click", C, { capture: !0 }), h = () => {
	...
	initHtml() {
		const t = document.createElement("div"), e = t.attachShadow({ mode: "open" }), i = this.options.cspNonce && "string" == typeof this.options.cspNonce ? this.options.cspNonce.replace(/"/g, "") : "";
	...
	exportImage(e, i, n) {
		return t(this, void 0, void 0, (function* () {
			...
			return Promise.all(Array.from(t).map(((t) => new Promise(((n, s) => {
				t.toBlob(((t) => {
					t ? n(t) : s(/* @__PURE__ */ new Error("Could not export image"));
				}), e, i);
			})))));
		}));
	}
...
var w = class w extends u {
		...
		const { state: i, actions: n } = function(t) {
			...
			return {
				state: {
					...
					scrollPosition: y,
					canPlay: S,
					isReady: h((() => S.value && c.value > 0), [S, c]),
					progress: h((() => a.value), [a]),
					progressPercent: h((() => c.value > 0 ? a.value / c.value : 0), [a, c])
				},
				actions: {
					setCurrentTime: (t) => {
	...
	initPlayerEvents() {
		this.isPlaying() && (this.emit("play"), this.timer.start()), this.mediaSubscriptions.push(this.onMediaEvent("timeupdate", (() => {
			...
			var t;
			this.emit("error", null !== (t = this.getMediaElement().error) && void 0 !== t ? t : /* @__PURE__ */ new Error("Media error")), this.stopAtPosition = null;
		})));
	}
	initRendererEvents() {
	...
	initPlugins() {
		var t;
		null !== (t = this.options.plugins) && void 0 !== t && t.length && this.options.plugins.forEach(((t) => {
