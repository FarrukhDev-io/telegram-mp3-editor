...
var FFmpeg = class {
	...
	*/
	load = ({ classWorkerURL, ...config } = {}, { signal } = {}) => {
		if (!this.#worker) {
			this.#worker = classWorkerURL ? new Worker(new URL(classWorkerURL, import.meta.url), { type: "module" }) : new Worker(new URL("../../../../node_modules/@ffmpeg/ffmpeg/dist/esm/worker.js", import.meta.url), { type: "module" });
